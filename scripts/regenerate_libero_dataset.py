...
if __name__ == "__main__":
    ...
    parser.add_argument("--libero_raw_data_dir", type=str,
                        help="Path to directory containing raw HDF5 dataset. Example: ./third_party/LIBERO/libero/datasets/libero_spatial", required=True)
    parser.add_argument("--libero_target_dir", type=str,
                        help="Path to regenerated dataset directory. Example: ./third_party/LIBERO/libero/datasets/libero_spatial_no_noops", required=True)
